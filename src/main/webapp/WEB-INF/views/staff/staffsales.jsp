...
<%
	...
	Map<Integer, Integer> salePrice = (Map<Integer, Integer>)request.getAttribute("salePrice");
	int totalSales = (int)request.getAttribute("totalSales");
%>
<!DOCTYPE html>
                        ...
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 ms-auto">
                                	<form action="/staff/sales" method="get">
                            ...
                            <div class="table-responsive">
                                <table class="table no-wrap">
                                    <thead>
                                        <tr>
                                            <th class="border-top-0">고유번호</th>
                                            <th class="border-top-0">판매가격</th>
                                            <th class="border-top-0">영수증</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <%
                                    	for(int key:salePrice.keySet())
                                    	{	
                                    %>
                                    	<tr>
                                    		<td><%=key %></td>
                                    		<td><%=salePrice.get(key) %></td>
                                    		<td><button type="button" class="btn btn-primary" onclick="location.href='/staff/receipt/<%=key %>'">영수증출력</button></td>
                                    	<tr>
                                    <%  } %>
                                    </tbody>
                                </table>
                            ...
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">판매 총액</h3>
                                <div class="col-md-3 col-sm-4 col-xs-6 ms-auto">
                                	<h3><%=totalSales %></h3>
                                </div>
                            </div>
