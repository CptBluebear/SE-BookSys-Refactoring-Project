                    ...
                    <table class="table table-bordered text-center">
                        ...
                        <% for(int i=0;i<tableList.size();i++) { %>
                            <tr>
                                ...
                                %>
                                <td>
                                    <div class="margin-10px-top font-size14" onclick="postinfo('/staff/walkin/confirm', <%=tableList.get(i).getTableOid() %>, '<%=timeTable[j] %>')">O
                                    </div>
                                </td>
                                <%
                                		}
                                ...
                                %>
                                <td>
                                    <div class="margin-10px-top font-size14">X
                                    </div>
                                </td>
                                <%
                                		}
